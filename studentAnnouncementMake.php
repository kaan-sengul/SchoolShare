<?php 
    ...
    $query2 = "SELECT * FROM registers WHERE studentID ='$id' ";
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        {
            $query3 = "INSERT INTO announcements(announcementSubject, announcementMessage, announcementDate, announcementOwner, announcementCourse) 
            VALUES ('$subject', '$message', '$date', '$fullname', '$course')";
...
<?php include 'assets/header.php' ?>
  ...
  <!-- ======= Hero Section ======= -->
  <section id="hero">  
    <form method="POST" action="studentAnnouncementMake.php">
