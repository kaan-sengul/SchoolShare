<?php 
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        if($_SERVER["REQUEST_METHOD"] == "POST")
        {
            ...
            {
                $query3 = "INSERT INTO announcements(announcementSubject, announcementMessage, announcementDate, announcementOwner, announcementCourse) VALUES ('$subject', '$message', '$date', 'Admin', '$course')";
...
<?php include 'assets/adminHeader.php' ?>
  ...
  <!-- ======= Hero Section ======= -->
  <section id="hero">  
    <form method="POST" action="adminAnnouncementMake.php">
