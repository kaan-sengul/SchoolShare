...
<?php include 'assets/header.php' ?>
  ...
  <section id="hero">
    <table border=1  class="table table-striped table-dark" style="margin-left:300px;width:79%;">
        ...
        <tr align=center>   
            <td  align='right' colspan=6><a class="w3-btn w3-blue" href='studentAnnouncementMake.php'>Make Announcement +</a></td>
        </tr>
        <tr align='center'>
            <th>No</th>
            <th>Course</th>
                ...
                while($row = mysqli_fetch_assoc($result2))
                {
                    ...
                    echo "
                        <tr align='center'>
                            ...
                            <td><a class='w3-btn w3-blue' href='announcementSDetails.php?id=$row[announcementID]'>Details...</a></td>
                        </tr>
                        ";
                }
            }
