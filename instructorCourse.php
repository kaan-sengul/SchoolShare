  ...
  <section id="hero">
        ...
        if($result3)
        {
            ...
            while($row = mysqli_fetch_assoc($result3))
            {
                ...
                echo "<tr align=center>   
                      ...
                      <tr>
                        <td colspan=2><a class='w3-btn w3-blue' href='listStudents.php?course=$row[courseID]'>List students who take this course...</a></td>
                      </tr>
    ...
    foreach($file_list as $key=>$dat) { 
      if($i % 3 == 0)
      {
        ...
        <td align='center'>
          <a href = 'assets/download.php?file=".$dat."'><img width='50' height='50' src='assets/img/file.png'><br>$dat</a><br>
          <a href='assets/delete.php?file=".$dat."&course=$row[courseID]'>Delete</a>
        </td>"; 
      }
      else
      {
        echo "<td  align='center'  >
                <a href = 'download.php?file=".$dat."'><img width='50' height='50' src='assets/img/file.png'><br>$dat</a><br>
                <a href='assets/delete.php?file=".$dat."&course=$row[courseID]'>Delete</a>
              </td>"; 
      }
      $i++;
    ...
    <form enctype='multipart/form-data' method='post' action='assets/ftpI.php?course=$row[courseID]'>
