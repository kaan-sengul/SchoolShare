<?php
    ...
    if($t)
    {
        header("Location:../instructorCourse.php?course=$_GET[course]");
    }
    ...
    if (!$upload) 
    {
        echo header("Location:../instructorCourse.php?course=$_GET[course]");
    } 
    else 
    {
        
        header("Location:../instructorCourse.php?course=$id");
    }
